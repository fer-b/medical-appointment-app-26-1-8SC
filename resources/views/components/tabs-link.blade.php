...
<li class="me-2">
    ...
    class="inline-flex items-center justify-center p-4 border-b-2 rounded-t-lg hover:text-fg-brand group transition-colors duration-200 {{ $error ? 'text-red-600 border-red-600' : '' }}" 
